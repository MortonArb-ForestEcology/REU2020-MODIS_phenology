...
bud.ilic.list <- list(y = oak.budburst[oak.budburst$species == 'ilicifolia', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'ilicifolia', 'MinGDD5.cum']))
bud.imbr.list <- list(y = oak.budburst[oak.budburst$species == 'imbricaria', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'imbricaria', 'MinGDD5.cum']))
bud.macr.list <- list(y = oak.budburst[oak.budburst$species == 'macrocarpa', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'macrocarpa', 'MinGDD5.cum']))
bud.palu.list <- list(y = oak.budburst[oak.budburst$species == 'palustris', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'palustris', 'MinGDD5.cum']))
bud.shum.list <- list(y = oak.budburst[oak.budburst$species == 'shumardii', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'shumardii', 'MinGDD5.cum']))
bud.velu.list <- list(y = oak.budburst[oak.budburst$species == 'velutina', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'velutina', 'MinGDD5.cum']))
bud.gamb.list <- list(y = oak.budburst[oak.budburst$species == 'gambelii', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'gambelii', 'MinGDD5.cum']))
bud.mont.list <- list(y = oak.budburst[oak.budburst$species == 'montana', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'montana', 'MinGDD5.cum']))
bud.rubr.list <- list(y = oak.budburst[oak.budburst$species == 'rubra', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'rubra', 'MinGDD5.cum']))
bud.alba.list <- list(y = oak.budburst[oak.budburst$species == 'alba', 'MinGDD5.cum'], n = length(oak.budburst[oak.budburst$species== 'alba', 'MinGDD5.cum']))
...
ggplot(data= bud.first.mean) +
  ...
  scale_fill_manual(values=c("darkblue", "lightblue", "mediumspringgreen", "olivedrab2", 'goldenrod1','darkolivegreen4', 'goldenrod3', 'aquamarine3'
                             , 'olivedrab4', 'chartreuse3', 'forestgreen', 'lightgreen'))  +
  scale_x_continuous('Thermal Time Threshold (5C Growing Degree Days)') +
