...
summary(oak.leaves[!is.na(oak.leaves$first.min), 'species'])
...
#leaves list for dat.leaves$MinGDD5.cum
minleaf.ilic.list <- list(y = oak.leaves[oak.leaves$species == 'ilicifolia', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'ilicifolia', 'MinGDD5.cum']))
minleaf.imbr.list <- list(y = oak.leaves[oak.leaves$species == 'imbricaria', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'imbricaria', 'MinGDD5.cum']))
minleaf.macr.list <- list(y = oak.leaves[oak.leaves$species == 'macrocarpa', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'macrocarpa', 'MinGDD5.cum']))
minleaf.palu.list <- list(y = oak.leaves[oak.leaves$species == 'palustris', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'palustris', 'MinGDD5.cum']))
minleaf.shum.list <- list(y = oak.leaves[oak.leaves$species == 'shumardii', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'shumardii', 'MinGDD5.cum']))
minleaf.velu.list <- list(y = oak.leaves[oak.leaves$species == 'velutina', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'veultina', 'MinGDD5.cum']))
minleaf.gamb.list <- list(y = oak.leaves[oak.leaves$species == 'gambelii', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'gambelii', 'MinGDD5.cum']))
minleaf.mont.list <- list(y = oak.leaves[oak.leaves$species == 'montana', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'montana', 'MinGDD5.cum']))
minleaf.rubr.list <- list(y = oak.leaves[oak.leaves$species == 'rubra', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'rubra', 'MinGDD5.cum']))
minleaf.alba.list <- list(y = oak.leaves[oak.leaves$species == 'alba', 'MinGDD5.cum'], n = length(oak.leaves[oak.leaves$species== 'alba', 'MinGDD5.cum']))
...
leaf.first.min <- rbind(stats.greenup, stats.midgreenup, leaf.stats.alba, leaf.stats.mont, leaf.stats.gamb, leaf.stats.rubr, leaf.stats.ilic, leaf.stats.imbr
                       ,leaf.stats.macr, leaf.stats.palu, leaf.stats.shum, leaf.stats.velu)
leaf.first.min$name <- as.factor(leaf.first.min$name)
leaf.first.min$type <- as.factor(leaf.first.min$type)
summary(leaf.first.min)

library(ggplot2)
path.figures <- "../figures"
if(!dir.exists(path.figures)) dir.create(path.figures)
png(width= 750, filename= file.path(path.figures, paste0('Thresh_leaf_firstmin_MortonArb.png')))

ggplot(data= leaf.first.min) +
...
# save the outputs
path.mod.leaf.firstmin <- "../data_processed/leaf.firstmin.MortonArb"
if(!dir.exists(path.mod.leaf.firstmin)) dir.create(path.mod.leaf.firstmin)
write.csv(stats.greenup, file.path(path.mod.leaf.firstmin, "THRESH_MODIS_Greenup.csv"), row.names=F)
write.csv(stats.midgreenup, file.path(path.mod.leaf.firstmin, "THRESH_MODIS_MidGreenup.csv"), row.names=F)
write.csv(leaf.stats.alba, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_alba.csv"), row.names=F) 
write.csv(leaf.stats.mont, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_montana.csv"), row.names=F) 
write.csv(leaf.stats.gamb, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_gambelii.csv"), row.names=F) 
write.csv(leaf.stats.rubr, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_rubra.csv"), row.names=F) 
write.csv(leaf.stats.ilic, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_ilicifolia.csv"), row.names=F) 
write.csv(leaf.stats.imbr, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_imbricaria.csv"), row.names=F) 
write.csv(leaf.stats.macr, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_macrocarpa.csv"), row.names=F) 
write.csv(leaf.stats.palu, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_palustris.csv"), row.names=F) 
write.csv(leaf.stats.shum, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_shumardii.csv"), row.names=F) 
write.csv(leaf.stats.velu, file.path(path.mod.leaf.firstmin, "THRESH_leaf_firstmin_velutina.csv"), row.names=F) 
